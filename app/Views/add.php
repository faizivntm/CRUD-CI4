...
<body style="min-height: 100vh;" 
  ...
  <div class="card p-4" 
    ...
    <h3 class="mb-4 text-center" style="font-weight: 600;">Add New Item</h3>

    <form action="<?= base_url('/add/items') ?>" method="post">
      <?= csrf_field(); ?>
      ...
      <button type="submit" 
              ...
              style="color: white; border-radius: 8px; font-weight: 500;">
        Simpan Item
      </button>
    </form>
